...
export const STUDENT_PROFILE_INFO_ENDPOINT = ENV + "mock";
export const STUDENT_RESOLVED_PROBLEMS_ENDPOINT = ENV + "mock";
export const STUDENT_MARKED_PROBLEMS_ENDPOINT = ENV + "mock";
export const STUDENT_SUGGESTED_PROBLEMS_ENDPOINT = ENV + "mock";
export const RESOLVED_PROBLEM_ENDPOINT = ENV + "mock";
